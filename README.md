...
<img src="man/figures/logo.png" height="280" />
...
BiocManager::install(c("ComplexHeatmap", "BiocNeighbors", "GenomeInfoDbData", "DESeq2", "clusterProfiler", "org.Hs.eg.db", "org.Mm.eg.db"))
